...
# These dependencies are not automatically included with selfcord.py and need to be installed separately:
...
async def show_captcha(exc: selfcord.CaptchaRequired, client: commands.Bot) -> str:
